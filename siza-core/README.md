...
- `creature-rules.js` owns creature counters, equipped-card lookup, descriptor-driven Equipment power bonuses, effective power, and effective toughness. Arena injects `cardById` and the shared effect resolver; battlefield mutation remains local.
