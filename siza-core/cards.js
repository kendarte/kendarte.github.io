...
const cards=Object.freeze([
 Object.freeze({id:'mist',legacyFullCardImage:legacyFullCardImages.mist,name:'Niebla de Sal',type:'Instant',cost:1,difficulty:5,pips:{U:1},text:'Roba una carta.',flavor:'La marea guarda secretos incluso de quienes viven de ella.',role:'draw',art:'blue',glyph:'≈'}),
 Object.freeze({id:'spark',legacyFullCardImage:legacyFullCardImages.spark,name:'Chispa del Estuario',type:'Instant',cost:1,difficulty:5,pips:{R:1},text:'Inflige 2 de daño al Personaje rival.',flavor:'Una chispa basta cuando el aire sabe a sal.',role:'removal',art:'red',glyph:'✦'}),
 Object.freeze({id:'servitor',legacyFullCardImage:legacyFullCardImages.servitor,name:'Servidor Ahogado',type:'Creature',subtype:'Ahogado',cost:2,difficulty:6,pips:{U:1},power:2,toughness:2,text:'Cuando entra, observa la carta superior de tu Library.',flavor:'No respira. Recuerda.',role:'threat',art:'blue',glyph:'☠'}),
 Object.freeze({id:'ignimite',legacyFullCardImage:legacyFullCardImages.ignimite,name:'Ignimite',type:'Creature',subtype:'Elemental',cost:2,difficulty:6,pips:{R:1},power:1,toughness:1,text:'Cuando hace daño de combate, obtiene +1/+1.',flavor:'Toda llama aprende de aquello que consume.',role:'threat',art:'red',glyph:'♨'}),
 Object.freeze({id:'counter',legacyFullCardImage:legacyFullCardImages.counter,name:'Negación Pictomántica',type:'Instant',cost:2,difficulty:6,pips:{U:2},text:'Contrarresta el spell objetivo.',flavor:'No toda memoria merece cruzar.',role:'counter',art:'blue',glyph:'⊘'}),
 ...
 Object.freeze({id:'leviathan',legacyFullCardImage:legacyFullCardImages.leviathan,name:'Leviatán de la Campana',type:'Creature',subtype:'Leviatán',cost:7,difficulty:8,pips:{U:3},power:7,toughness:7,text:'Al entrar, devuelve otro permanente a la mano de su dueño.',flavor:'La campana no lo llama. Le recuerda que alguna vez estuvo despierto.',role:'finisher',art:'blue',glyph:'Ω'}),
 ...
 Object.freeze({id:'queen',legacyFullCardImage:legacyFullCardImages.queen,name:'Memoria de la Reina Ahogada',type:'Creature',subtype:'Avatar',cost:5,difficulty:8,pips:{U:3},power:5,toughness:5,text:'Al entrar, roba dos cartas y luego descarta una.',flavor:'La corona sobrevivió porque nadie recordó enterrarla.',role:'finisher',art:'multi',glyph:'♛',adventureUnlock:true})
]);
