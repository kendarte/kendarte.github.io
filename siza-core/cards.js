...
function equipmentTokenImage(glyph,label,accent){
 const svg=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 196"><defs><linearGradient id="g" x1="0" y1="0" x2="0" y2="1"><stop stop-color="#102b3e"/><stop offset="1" stop-color="#06131d"/></linearGradient></defs><rect width="140" height="196" rx="12" fill="url(#g)"/><rect x="5" y="5" width="130" height="186" rx="10" fill="none" stroke="#b88a42" stroke-width="4"/><rect x="12" y="12" width="116" height="172" rx="8" fill="none" stroke="${accent}" stroke-width="2" opacity=".85"/><text x="70" y="105" text-anchor="middle" font-size="62" fill="#f3e5be" font-family="Georgia,serif">${glyph}</text><text x="70" y="160" text-anchor="middle" font-size="14" fill="#d5c28f" font-family="Georgia,serif">${label}</text></svg>`;
...
const cards=Object.freeze([
 ...
 Object.freeze({id:'tideblade',legacyFullCardImage:legacyFullCardImages.tideblade,finalCardImage:equipmentTokenImage('†','ESPADA','#6f9bb7'),name:'Espada de Bajamar',type:'Artifact',cost:3,difficulty:6,pips:{U:1},equipCost:1,text:'La criatura equipada obtiene +2/+0. Equipar {1}.',flavor:'Forjada donde el agua revela lo que la marea quiso ocultar.',role:'utility',art:'blue',glyph:'†',effects:Object.freeze([Object.freeze({event:'equipped',type:'modify-power',amount:2})])}),
