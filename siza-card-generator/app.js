...
function newBlank(){return{...EXAMPLE,id:'card_'+Date.now(),name:'Carta sin nombre',template:'standard',templateParts:{},frameUrl:'',frameAssetKey:'',difficulty:1,cost:1,pips:{},artId:'',artUrl:'',artAssetKey:'',artTransform:{x:50,y:50,scale:1},battleSpriteUrl:'',battleSpriteAssetKey:'',battleSpriteTransform:{x:50,y:50,scale:1},rules:'',flavor:'',force:2,resistance:2,cardNumber:'000',glyph:'✦',effects:[]};}
