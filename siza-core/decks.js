...
const dragonThunderCards=Object.freeze([
 freezeCard({id:'dtc_familiar_conductor',name:'Familiar Conductor',type:'Creature',subtype:'Familiar',difficulty:4,pips:{U:1},power:1,toughness:1,text:'Exhaust: +1 to a Manafestation roll for a Dragon Invocation.',flavor:'It does not summon the storm. It teaches the storm where to land.',role:'ramp',art:'blue',glyph:'◈',effects:[{event:'manifest-roll',type:'dragon-manifest-bonus',amount:1,requiresSubtype:'Dragon',exhaustSource:true}]}),
 freezeCard({id:'dtc_reactor_weaver',name:'Reactor Weaver',type:'Creature',subtype:'Spider',difficulty:5,pips:{U:1},power:2,toughness:2,text:'Exhaust: +1 to a Red or Blue Manafestation roll. Whenever you successfully manifest a D7+ Dragon, ready Reactor Weaver.',flavor:'Its web vibrates before the first wingbeat.',role:'ramp',art:'blue',glyph:'✣',effects:[{event:'manifest-roll',type:'storm-manifest-bonus',amount:1,requiresColors:['R','U'],exhaustSource:true},{event:'manifest-success',type:'ready-source',requiresSubtype:'Dragon',minDifficulty:7}]}),
 freezeCard({id:'dtc_dragonstorm_front',name:'Dragonstorm Front',type:'Artifact',subtype:'Relic',difficulty:5,pips:{R:1},text:'Whenever a Dragon Invocation enters under your control, deal 1 damage to the opposing Character. Each Dragonstorm Front triggers separately.',flavor:'The sky burns before the dragon arrives.',role:'engine',art:'red',glyph:'ϟ',effects:[{event:'ally-enter',type:'ally-enter-damage',requiresSubtype:'Dragon',amount:1,thresholdCount:0,thresholdAmount:0}]}),
 freezeCard({id:'dtc_predators_ascension',name:"Predator's Ascension",type:'Artifact',subtype:'Relic',difficulty:5,pips:{U:1},text:'The first time each turn an Invocation with 4 or more ATK enters under your control, draw 1 card.',flavor:'Power announces itself long before it attacks.',role:'engine',art:'blue',glyph:'▲',effects:[{event:'ally-enter',type:'ally-enter-draw',amount:1,minPower:4,oncePerTurn:true}]}),
 freezeCard({id:'dtc_crucible_of_the_bloodline',name:'Crucible of the Bloodline',type:'Artifact',subtype:'Relic',difficulty:6,pips:{R:1,U:1},text:'Your Dragon Invocations get +1/+1.',flavor:'Blood remembers the shape of fire.',role:'engine',art:'multi',glyph:'◆',effects:[{event:'static',type:'tribal-stat-bonus',requiresSubtype:'Dragon',powerDelta:1,toughnessDelta:1}]}),
 ...
 freezeCard({id:'dtc_thunderfront_regent',name:'Thunderfront Regent',type:'Creature',subtype:'Dragon',difficulty:6,pips:{R:2},power:4,toughness:4,text:'Whenever an opposing Reaction targets one of your Dragons, deal 1 damage to the opposing Character.',flavor:'Threaten the brood and the answer comes from the clouds.',role:'threat',art:'red',glyph:'♛',effects:[{event:'targeted-by-opponent',type:'targeted-subtype-damage',requiresTargetSubtype:'Dragon',amount:1}]}),
 freezeCard({id:'dtc_caldera_scourge',name:'Caldera Scourge',type:'Creature',subtype:'Dragon',difficulty:7,pips:{R:2},power:4,toughness:4,text:'Whenever this or another Dragon enters under your control, deal 1 damage to the opposing Character. If you control three or more Dragons, deal 2 instead.',flavor:'One dragon is an omen. Three are a weather system.',role:'engine',art:'red',glyph:'Ω',effects:[{event:'ally-enter',type:'ally-enter-damage',requiresSubtype:'Dragon',amount:1,thresholdCount:3,thresholdAmount:2}]}),
 freezeCard({id:'dtc_ash_collector',name:'Ash Collector',type:'Creature',subtype:'Dragon',difficulty:7,pips:{R:2},power:5,toughness:5,text:'When Ash Collector enters, the opponent chooses one: sacrifice an Invocation; or take 3 damage.',flavor:'Its tribute is paid in flesh or smoke.',role:'threat',art:'red',glyph:'◇',effects:[{event:'enter',type:'sacrifice-or-damage',target:'opponent',amount:3}]}),
 freezeCard({id:'dtc_cinderwing_twin',name:'Cinderwing Twin',type:'Creature',subtype:'Dragon',difficulty:6,pips:{R:2},power:4,toughness:4,text:'If you used 2 or more Mana Burn to complete this Manafestation, create a 3/3 Dragon Invocation token.',flavor:'The second shadow appears only after the fire is fed.',role:'threat',art:'red',glyph:'∞',effects:[{event:'manifest-success',type:'burn-create-token',minBurn:2,tokenId:'dtc_dragon_token',tokenName:'Dragon Token',tokenPower:3,tokenToughness:3,tokenSubtype:'Dragon'}]}),
 freezeCard({id:'dtc_fulminated_ridge_tyrant',name:'Fulminated Ridge Tyrant',type:'Creature',subtype:'Dragon',difficulty:7,pips:{R:2,U:1},power:4,toughness:5,text:'When Fulminated Ridge Tyrant enters, deal 2 damage to any target.',flavor:'The ridge cracked because it landed there once.',role:'removal',art:'multi',glyph:'ϟ',effects:[{event:'enter',type:'damage-target',targetScope:'any-target',amount:2}]}),
 freezeCard({id:'dtc_cataclysm_maw',name:'Cataclysm Maw',type:'Creature',subtype:'Dragon',difficulty:8,pips:{R:2,U:1},power:7,toughness:7,text:'Whenever Cataclysm Maw attacks, deal 3 damage to the opposing Character and 1 damage to up to two opposing Invocations.',flavor:'It does not enter a battle. It changes the geography.',role:'finisher',art:'multi',glyph:'Ω',effects:[{event:'attack-declared',type:'damage-character',target:'opponent',amount:3},{event:'attack-declared',type:'attack-splash-damage',amount:1,maxTargets:2}]}),
 freezeCard({id:'dtc_variable_ember_devastator',name:'Variable Ember Devastator',type:'Creature',subtype:'Dragon',difficulty:5,pips:{R:1},power:1,toughness:1,text:'Variable Ember Devastator enters with one +1/+1 counter for each Mana Burn used to complete its Manafestation.',flavor:'Feed the spark. Decide how large the disaster becomes.',role:'threat',art:'red',glyph:'✦',effects:[{event:'enter',type:'add-counter',targetScope:'source',counterType:'plus1-plus1',amount:0,amountFrom:'burnUsed'}]}),
 ...
 freezeCard({id:'dtc_mutagenic_stomper',name:'Mutagenic Stomper',type:'Creature',subtype:'Dragon Shapeshifter',difficulty:5,pips:{R:1,U:1},power:4,toughness:2,text:'Trample.',flavor:'Too many wings. Too much mass. Exactly enough momentum.',role:'threat',art:'multi',glyph:'»',effects:[{event:'static',type:'grant-keyword',targetScope:'source',keyword:'trample',duration:'permanent'}]}),
 freezeCard({id:'dtc_brotherhoods_end',name:"Brotherhood's End",type:'Instant',difficulty:6,pips:{R:1},text:'Deal 2 damage to all Invocations.',flavor:'When the formation breaks, everyone burns together.',role:'removal',art:'red',glyph:'✹',effects:[{event:'resolve',type:'damage-target',targetScope:'each-creature',amount:2}]}),
 freezeCard({id:'dtc_hunting_frenzy',name:'Hunting Frenzy',type:'Instant',difficulty:5,pips:{R:1},text:'Deal 3 damage to target Invocation.',flavor:'The chase ends at the first mistake.',role:'removal',art:'red',glyph:'×',effects:[{event:'resolve',type:'damage-target',targetScope:'target-creature',amount:3}]}),
 freezeCard({id:'dtc_lightning_strike',name:'Lightning Strike',type:'Instant',difficulty:5,pips:{R:1},text:'Deal 2 damage to target Invocation or Character.',flavor:'Fast enough to become a decision instead of an event.',role:'removal',art:'red',glyph:'ϟ',effects:[{event:'resolve',type:'damage-target',targetScope:'any-target',amount:2}]}),
 freezeCard({id:'dtc_flash_discharge',name:'Flash Discharge',type:'Instant',difficulty:4,pips:{R:1},text:'Deal 1 damage to any target.',flavor:'Small sparks still choose where the fire begins.',role:'removal',art:'red',glyph:'✦',effects:[{event:'resolve',type:'damage-target',targetScope:'any-target',amount:1}]}),
 freezeCard({id:'dtc_airship_fall',name:'Airship Fall',type:'Instant',difficulty:5,pips:{U:1},text:'Destroy target Relic. If you do not, draw 1 card, then discard 1 card.',flavor:'Anything that flies eventually negotiates with gravity.',role:'utility',art:'blue',glyph:'⌄',effects:[{event:'resolve',type:'destroy-relic-or-loot'}]}),
 freezeCard({id:'dtc_pictomantic_suplex',name:'Pictomantic Suplex',type:'Instant',difficulty:5,pips:{R:1},text:'Choose one — Deal 3 damage to target Invocation; if it dies this turn, exile it. Or exile target Relic.',flavor:'Technique first. Humiliation second.',role:'removal',art:'red',glyph:'↯',effects:[{event:'resolve',type:'modal-damage-or-exile-relic',amount:3,exileIfDies:true}]}),
 freezeCard({id:'dtc_subsurface_missile',name:'Subsurface Missile',type:'Instant',difficulty:5,pips:{R:1},text:'Deal 2 damage to target Invocation. You may put a card from your hand on the bottom of your Library. If you do, draw 1 card.',flavor:'The street only looks solid from above.',role:'removal',art:'red',glyph:'↑',effects:[{event:'resolve',type:'damage-target',targetScope:'target-creature',amount:2},{event:'resolve',type:'bottom-then-draw',optional:true}]}),
 freezeCard({id:'dtc_war_kick',name:'War Kick',type:'Instant',difficulty:5,pips:{U:1},text:'One of your Invocations deals damage equal to its ATK to target opposing Invocation. If Mana Burn was used to manifest War Kick, it deals double that damage instead.',flavor:'Commit the whole body or do not kick at all.',role:'removal',art:'blue',glyph:'★',effects:[{event:'resolve',type:'fight',targetScope:'source',secondTargetScope:'target-creature',doubleIfBurn:true}]}),
 ...
 freezeCard({id:'dtc_dragon_token',name:'Dragon Token',type:'Creature',subtype:'Dragon',difficulty:1,pips:{},power:3,toughness:3,text:'Token Invocation.',flavor:'The storm leaves a second shadow behind.',role:'token',art:'multi',glyph:'Ω'})
]);
...
const VERSION='1.2.0',FORMAT='Siza Core 60',freezeCounts=counts=>Object.freeze({...counts});
