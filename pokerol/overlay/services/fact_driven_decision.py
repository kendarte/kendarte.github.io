...
from services.fact_share_rule_engine import FACT_SHARE_RULE_BUILD
...
def choose_goal(npc):
    ...
    social_refresh = refresh_holder_aware_fact_share_obligations(npc)
    ...
    packet["fact_share_holder_acquisition_build"] = FACT_SHARE_HOLDER_ACQUISITION_BUILD
