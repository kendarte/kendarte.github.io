(function(){
'use strict';
var BUILD='0.1.1-idempotent-attacks-guard',observer=null;
function clean(){
  ...
  // Writing identical text still queues a childList mutation. This observer
  // watches the hint too, so only write when the label actually changes.
  var hint=document.getElementById('pkb-command-hint');if(hint&&hint.textContent!=='ATAQUES + ACCIONES')hint.textContent='ATAQUES + ACCIONES';
