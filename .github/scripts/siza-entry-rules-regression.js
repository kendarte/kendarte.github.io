...
test('Impulso permite una Invocación de un cristal pero no una de dos',()=>{const M=fresh('oneCrystal');add(M.player,'reg_entry_one',3);add(M.player,'reg_entry_two',3);return H.spellCostV070(dom.window.SizaCardCatalog.get('mist'))>=1&&!H.preparingV070(M.player,0)&&H.preparingV070(M.player,1)&&H.canAttackV070(M.player,0)&&!H.canAttackV070(M.player,1)});
